...
public class RejectedAdapter extends FirebaseRecyclerAdapter<Booking2,RejectedAdapter.myviewholder>
{

    public RejectedAdapter(@NonNull FirebaseRecyclerOptions<Booking2> options) {
        super(options);
    }
